...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_list", default="voc12/train_aug2.txt", type=str)
...
##true改成false batch16to2 epoch15to5
    ...
    val_dataset = voc12.data.VOC12ClsDataset(args.val_list, voc12_root=args.voc12_root,transform=transforms.Compose([np.asarray,model.normalize,imutils.CenterCrop(500),imutils.HWC_to_CHW,torch.from_numpy]))
    ...
    if args.weights[-7:] == '.params':
        ...
        weights_dict = ne
        twork.vgg16d.convert_caffe_to_torch(args.weights)
    else:
